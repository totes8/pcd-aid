  ...
  <section class="card">
    ...
    <div v-if="adding" class="composer">
      <label class="field full">
        ...
        <textarea v-model="newReport" rows="5" class="input" placeholder="Write HSVM report..."></textarea>
      </label>
      ...
      <div class="composer-actions">
        ...
        <button class=" button--accent" :disabled="!canSaveNew" @click="saveNew">Save</button>
      </div>
    </div>

    <div v-if="entries.length === 0" class="empty">
      <p class="muted">No HSVM reports yet.</p>
    </div>
...
const entries = computed(() => store.listHsvm(props.patientId));
