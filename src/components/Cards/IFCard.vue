  ...
  <section class="card">
    ...
    <div v-if="adding" class="composer">
      <label class="field full">
        ...
        <textarea v-model="newReport" rows="5" class="input" placeholder="Write IF report..."></textarea>
      </label>
    ...
    <div v-if="entries.length === 0" class="empty">
      <p class="muted">No IF reports yet.</p>
    </div>
...
const entries = computed(() => store.listIf(props.patientId));
...
function saveEdit() {
  ...
  store.updateIf(props.patientId, editingId.value, {
    report,
    date: editDate.value,
